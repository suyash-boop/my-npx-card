...
╚═╝░░╚═╝╚═╝  ░░░╚═╝░░░╚═╝░░╚═╝╚══════╝╚═╝░░╚═╝╚══════╝ ╚═╝╚═╝`.magenta)
    ...
    console.log()
    const spinner = createSpinner('Loading Suyash\'s details').start()
...
█▀▀ ██▄ █▀▄ ▄█ █▄█ █░▀█ █▀█ █▄▄   █▄▀ ██▄ ░█░ █▀█ █ █▄▄ ▄█`.yellow);
    ...
    const githubLink = link('btw its awesome -> ','https://github.com/suyash-boop');
    // const websiteLInk = link('Coolest thing -> ','https://vineet.tech');
    console.log(`NAME    `.green + ' - ' + 'Suyash Padole'.cyan);
...
console.log()
console.log('Suyash is up for hire, ready to help your company get to next heights and ofc Thanks for checking out my cli!'.magenta)
console.log()
}
